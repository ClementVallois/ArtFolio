    ...
    <div  v-show="showModal == true" class="fixed z-20 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white shadow-lg rounded-lg p-8 dark:bg-gray-800">
        ...
        <div class="relative p-1 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-4 dark:bg-gray-800">
                ...
                <div class="flex justify-center items-center space-x-4">
                    ...
                    <button type="submit" @click="deleteItem()" class="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">Yes, I'm sure</button>
                </div>
            </div>
    </div>
</template>
