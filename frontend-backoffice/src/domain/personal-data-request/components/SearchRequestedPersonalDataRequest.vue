<template>
    ...
    <form class="flex items-center">
        ...
        <div class="relative w-full">
            ...
            <input type="text" id="simple-search" :value="searchValue" @input="updateFilterValue"
                class="bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-2 focus-visible:ring-black-500 focus:ring-black-500 focus:border-black-500 block w-full pl-10 p-2 outline-none"
...
const updateFilterValue = event => {
    ...
    if (searchValue.value != '') {
        storePersonalDataRequest.filterPersonalDataRequest(searchValue)
