...
- **Backend** : Une [architecture sophistiquée en Domain Driven Development](https://github.com/ClementVallois/ArtFolio/tree/main/backend-api) pour gérer les interactions de données. Notre backend type ses données avec TypeScript et utilise NestJs.
